...
addRecipes(){
    axios.post('/my_recipes_book/v1/users_recipes',
    {
    "userName": this.state.userName,
	"recipesName":this.state.fullName,
	"recipesIngredients":this.state.email,
    "recipesCooking":this.state.password,
    "recipesPicture":this.state.pictureRecipe
